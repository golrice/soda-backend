...
def Register(request):
    if request.method == "POST":
        try:
            ...
            user = User.objects.create(username=username, email=email, password=password,first_name=firstName,last_name=lastName,date_joined=register_time,last_login=register_time)
